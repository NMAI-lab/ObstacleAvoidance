...
public class RoboWhistleSimulate extends Thread {
	...
	public RoboWhistleSimulate(EnvironmentModel mdl, String s) {
		this.model = mdl;
		try {
			bw = new BufferedWriter(new FileWriter("log_whistle" + s + ".txt"));
		} catch (IOException e) {
	...
	public static void main(String[] args) {
		...
		RoboWhistleSimulate robo = new RoboWhistleSimulate(mdl, args[0]);
