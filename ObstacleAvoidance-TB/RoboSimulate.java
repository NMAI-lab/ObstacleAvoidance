...
public class RoboSimulate extends Thread {
	...
	public RoboSimulate(EnvironmentModel mdl, String s) {
		this.model = mdl;
		try {
			bw = new BufferedWriter(new FileWriter("log_toggle" + s + ".txt"));
		} catch (IOException e) {
	...
	public static void main(String[] args) {
		...
		RoboSimulate robo = new RoboSimulate(mdl, args[0]);
